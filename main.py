...
async def get_address(msg: types.Message, state: FSMContext):
  ...
  print("Всего подписчиков: " + str(sumAllMembers))
  msgJoined += "\n\n<b>Количество подписчиков: </b>" + str(sumAllMembers[-1])
  print("Начало индекса: " + str(startIndexOfMemberList))
  print("Конец индекса: " + str(endIndexOfMemberList))
  try:
